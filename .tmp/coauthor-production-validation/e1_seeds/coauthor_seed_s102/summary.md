...
|---|---|---:|---|---|---|---|
| selection_minority_exclusion | selection | 0.0249894 | aggregation | local | unresolved | unresolved |
| compression_aggressive_topk | compression | 0.0209241 | aggregation | compression | unresolved | unresolved |
